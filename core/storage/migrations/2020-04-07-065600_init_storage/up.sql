...
CREATE TABLE account_tokens_updates (
    token_update_id serial NOT NULL,
    account_id BIGINT NOT NULL,
    block_number BIGINT NOT NULL,
...
CREATE INDEX account_tokens_updates_block_index ON account_tokens_updates (block_number);
