...
contract ConfigTest {
    ...
    uint256 constant ERC721_WITHDRAWAL_GAS_LIMIT = 2500000;
    ...
    uint16 constant MAX_AMOUNT_OF_REGISTERED_TOKENS = 4;
    function get_MAX_AMOUNT_OF_REGISTERED_TOKENS() external pure returns (uint16) {
        return MAX_AMOUNT_OF_REGISTERED_TOKENS;
    }
    ...
    uint256 constant ONCHAIN_WITHDRAWAL_BYTES = 1 + 20 + 2; // (uint8 addToPendingWithdrawalsQueue, address _to, uint16 _tokenId, uint128 _amount)
