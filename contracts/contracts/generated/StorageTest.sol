...
contract StorageTest {
    ...
    /// @notice VerifierTest contract. Used to verify block proof and exit proof
    VerifierTest internal verifier;

    /// @notice GovernanceTest contract. Contains the governor (the owner) of whole system, validators list, possible tokens list
    ...
    mapping(bytes22 => BalanceToWithdraw) public balancesToWithdraw; // ADE: to be changed as we don't use an ERC20 anymore
