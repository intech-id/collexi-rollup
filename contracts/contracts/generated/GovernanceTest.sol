...
/// @author Matter Labs
contract GovernanceTest is ConfigTest {
    ...
    /// @notice GovernanceTest contract initialization. Can be external because Proxy contract intercepts illegal calls of this function.
    ...
    function setERC721Address(address _tokenAddr) external {
        requireGovernor(msg.sender);
        erc721address = _tokenAddr;
        emit NewERC721Address(_tokenAddr);
    }
